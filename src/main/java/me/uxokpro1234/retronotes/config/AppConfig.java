package me.uxokpro1234.retronotes.config;
...
public class AppConfig {
    ...
    // APP INFO
    public static final String APP_NAME = "RetroNotes 2003 Professional Edition";

    public static final String VERSION = "Build 1.0.3";
    ...
    public static final Color LOG_GREEN = new Color(0,255,0);
    ...
    // BUTTONS
    public static final Dimension TOOLBAR_BUTTON_SIZE = new Dimension(90,25);
